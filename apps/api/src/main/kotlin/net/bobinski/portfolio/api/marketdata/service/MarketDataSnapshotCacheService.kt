...
@Serializable
private data class StoredQuoteSnapshot(
    val identity: String,
    val valuedAt: String,
...
@Serializable
private data class StoredSeriesSnapshot(
    val identity: String,
    val points: List<StoredPricePoint>
)

@Serializable
private data class StoredPricePoint(
    val date: String,
    val closePricePln: String
)

@Serializable
private data class StoredMonthlyInflationSnapshot(
    val identity: String,
    val points: List<StoredMonthlyInflationPoint>
)

@Serializable
private data class StoredMonthlyInflationPoint(
    val month: String,
    val multiplier: String
)

@Serializable
private data class StoredInflationWindow(
    val from: String,
    val until: String,
    val multiplier: String
)
