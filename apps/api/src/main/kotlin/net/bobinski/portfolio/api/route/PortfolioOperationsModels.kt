...
data class PortfolioBackupStatusResponse(
    ...
    val nextPostChangeBackupAt: String?,
    val running: Boolean,
...
internal fun PortfolioBackupStatus.toResponse(): PortfolioBackupStatusResponse = PortfolioBackupStatusResponse(
    ...
    postChangeEnabled = postChangeEnabled,
    postChangeDebounceSeconds = postChangeDebounceSeconds,
    postChangeMaxDelaySeconds = postChangeMaxDelaySeconds,
    postChangeRetentionCount = postChangeRetentionCount,
    safetyRetentionDays = safetyRetentionDays,
    hasUnprotectedChanges = hasUnprotectedChanges,
    pendingSince = pendingSince?.toString(),
    nextPostChangeBackupAt = nextPostChangeBackupAt?.toString(),
    running = running,
    lastRunAt = lastRunAt?.toString(),
    lastSuccessAt = lastSuccessAt?.toString(),
    lastFailureAt = lastFailureAt?.toString(),
