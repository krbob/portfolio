...
const auditActionLabels: Record<string, MessageKey> = {
  ...
  PORTFOLIO_TARGET_SCHEDULE_REPLACED: 'label.auditActionPortfolioTargetScheduleReplaced',
  ...
  WITHDRAWAL_PLANNING_SETTINGS_UPDATED: 'label.auditActionWithdrawalPlanningSettingsUpdated',
