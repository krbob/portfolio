...
export const appMessages = {
  ...
  'auth.startupRetryDescription': {
    pl: 'Nie udało się pobrać stanu startowego. Krótka przerwa podczas wdrożenia zostanie ponowiona automatycznie; możesz też spróbować ponownie.',
    en: 'The startup state could not be loaded. A short deployment interruption is retried automatically; you can also try again.',
  },
